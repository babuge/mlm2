...
export class ContactPage {
  ...
  constructor(public navCtrl: NavController,public unithttp:unitHttp,public tabCtrl:TabsService) {
  ...
  let url=this.unithttp.getIp().code+"/Api/Goods/selGoodsBytype";
